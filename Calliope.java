...
public class Calliope extends AdvancedRobot
{
	...
	private boolean changeBehaviour = false;
     ...
     */
        ...
        {		
                ...
                // and if time > 24 ticks
                if(isLastEnemy()){
                	changeBehaviour = true;
                	out.println("AGGRO MODE");
        ...
        //and if ticks are > 24
        private boolean isLastEnemy(){
        	int i = 0;
        	if(getTime() < 24) return false;
        	for(String s: enemies.keySet()){	
        		BadBoy iter = enemies.get(s);
        		if(iter.hp){
        			i++;
        		}
        	}
